...
const boundaryDefs: LexiconDoc = {
  lexicon: 1,
  id: "app.northsky.stratos.boundary.defs",
  defs: {
    Domain: {
      type: "object",
      ...
      record: {
        ...
        properties: {
          ...
          boundaries: {
            ...
            items: {
              type: "ref",
              ref: "app.northsky.stratos.boundary.defs#Domain",
            },
            maxLength: 50,
          },
          createdAt: {
...
const feedPost: LexiconDoc = {
  lexicon: 1,
  id: "app.northsky.stratos.feed.post",
  defs: {
    main: {
      type: "record",
      description:
      ...
      record: {
        ...
        properties: {
          source: {
            type: "ref",
            ref: "app.northsky.stratos.defs#source",
            description:
          ...
          boundary: {
            ...
            refs: ["app.northsky.stratos.boundary.defs#Domains"],
          },
          facets: {
            type: "array",
...
export const stratosLexicons: Record<string, LexiconDoc> = {
  "app.northsky.stratos.defs": stratosDefs,
  "app.northsky.stratos.boundary.defs": boundaryDefs,
  "app.northsky.stratos.actor.enrollment": actorEnrollment,
  "app.northsky.stratos.feed.post": feedPost,
};
